document.addEventListener("DOMContentLoaded", function(event){
  ...
  function insert(){
    ...
    var personne = p.value;// je cible ce que je veut recuper en l'occurence  le champs de formulaire la personne
    ...
    r.open("POST", "ajax7.php", true);// je prepare le fichier php
